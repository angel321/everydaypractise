...
def taxable_amount_after_exemption(yearly_gross_salary,exempted_amount):
...
if choice== "1":
     ...
     taxable_amount= taxable_amount_after_exemption(yearly_gross_salary,exempted_amount)
